        ...
        <div class="col-md-12">
            ...
            <form method="post" action="bindUserToQQ" id="fm1" htmlEscape="true">
				...
				<tr>
					...
					<td><p for="username">用户名：</p></td><td>
							<input type="text" class="form-control"  id="username" name="username" autocomplete="false" htmlEscape="true" />
                    </td>
					</tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <input class="mybutton" name="submit" accesskey="l" value="绑定" tabindex="4" type="submit" />
                        </td>
                    </tr>
					<tr>
                        <td colspan="2" >
